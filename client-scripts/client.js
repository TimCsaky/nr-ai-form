console.log('clientInstance:', localStorage.getItem('clientInstance') || 'none');
...
const isAIAssistantEnabled = Boolean(document.querySelector('[ai-mode]') || localStorage.getItem('clientInstance') === 'css');
